...
export function Leaderboard() {
  ...
  return (
    <div className="fade">
      <PageHeader title="Leaderboard" description={<>Desks with at least $1K of priced volume, ranked by {text}.</>} />
      ...
      <div className="mt-4">
        {q.isPending ? <Loading what="the leaderboard" /> : q.isError ? <Failed what="the leaderboard" error={q.error} /> : <DeskTable rows={q.data} rank highlight={mode === "edge" ? "edge" : mode === "markout" || mode === "adverse" ? "m1h" : "m5"} />}
      </div>
