...
install -m 644 /home/naumachy/naumachy/infra/vps/aquascan-api.service /home/naumachy/naumachy/infra/vps/aquascan-enrich.service /home/naumachy/naumachy/infra/vps/aquascan-mcp.service /etc/systemd/system/ && systemctl daemon-reload
systemctl restart aquascan-api aquascan-enrich aquascan-mcp
sleep 5; systemctl is-active aquascan-api aquascan-enrich aquascan-mcp | tr '\n' ' '; echo; curl -s -o /dev/null -w 'web %{http_code}\n' http://127.0.0.1/ -H 'Host: naumachy.xyz'
