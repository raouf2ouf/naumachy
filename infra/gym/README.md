...
- **informed flow**: before a tape swap large enough to move a pool replays, it sells the same token to the gladiators at the old price. An arbitrageur who sees the order flow does exactly this; it is the flow that bleeds the mainnet desks.
